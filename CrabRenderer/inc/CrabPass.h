...
//
//                GetGlobalConstants()->UpdateReflectCamera(CB_CAMERA {
//                    .view           = Mat4::Identity,
//                    .viewProj       = viewProj,
//                    .invViewProj    = Mat4::Identity,
//                    .cb_cameraPosition = t.position });
//
...
//        auto&                  r = GetRenderer();
//        CB_LIGHT          lightConst;
//        CB_SHADOW_RECEIVER shadowConst;
//        uint32                 lightIndex = 0;
//
...
//                    return;
//
//                lightConst.light[lightIndex] = LightSubdata {
//                    .cb_lightPosition  = t.position,
//                    .cb_lightType      = l.cb_lightType,
//                    .cb_lightDirection = t.Forward(),
//                    .useShadow      = l.useShadow,
//                    .cb_lightRadiance  = l.cb_lightRadiance,
//                    .cb_fallOffStart   = l.cb_fallOffStart,
//                    .cb_fallOffEnd     = l.cb_fallOffEnd,
//                    .cb_lightStrength  = l.cb_lightStrength,
...
//                            shadowConst.cb_cascadeRange1 = l.cascadeRange[0];
//                            shadowConst.cb_cascadeRange2 = l.cascadeRange[1];
//                            shadowConst.cb_cascadeRange3 = l.cascadeRange[2];
//
//                            // bind shadow map
...
//
//                            // update constant buffer
//                            Mat4 proj = MatrixUtil::CreatePerspective(PI_DIV2, 1.f, LIGHT_NEAR_PLANE, l.cb_fallOffEnd);
...
//                                                 * MatrixUtil::CreatePerspective(l.outerConeAngle, 1.f, LIGHT_NEAR_PLANE, l.cb_fallOffEnd);
