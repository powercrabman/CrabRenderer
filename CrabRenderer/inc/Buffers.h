...
public:
    ...
    void Init(const std::vector<VertexType>& in_vertices)
    {
        ...
        m_buffer       = d3d11::buffer::CreateBuffer(
...
public:
    ...
    constexpr uint32 GetIndexStride() const { return sizeof(Index); }
...
public:
    ...
    Ref<BufferShaderResource>  GetShaderResource() const { return m_shaderResource; }

private:
    ComPtr<ID3D11UnorderedAccessView> m_uav;
    Ref<BufferShaderResource>         m_shaderResource;
};
...
public:
    void Init(const std::vector<T>& in_data)
    {
        ...
        m_gpuBuffer = d3d11::buffer::CreateBuffer(
            byteWidth,
            D3D11_USAGE_DEFAULT,
...
public:
    ...
    Ty   GetCPUData() const { return in_cpuData; }
...
void ConstantBuffer<Ty>::WriteToBuffer(const Ty& in_data)
{
    ...
    {
        d3d11::buffer::WriteToDynamicBuffer(
            m_buffer.Get(),
            &in_data,
            sizeof(Ty));
